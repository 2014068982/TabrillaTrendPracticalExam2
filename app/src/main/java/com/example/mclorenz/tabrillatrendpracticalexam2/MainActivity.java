package com.example.mclorenz.tabrillatrendpracticalexam2;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firstbutton = (Button) findViewById(R.id.btnaverage);
        firstname = (EditText)  findViewById(R.id.fname);
        lastname = (EditText)findViewById(R.id.lname);
        result = (TextView)findViewById(R.id.etresult);
        exam1 = (EditText)findViewById(R.id.grade1);
        exam2 = (EditText)findViewById(R.id.grade2);
